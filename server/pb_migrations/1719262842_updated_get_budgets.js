...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("eszm1szj")

  // remove
  collection.schema.removeField("upxuoo9c")

  // remove
  collection.schema.removeField("khi0ujic")

  // remove
  collection.schema.removeField("y9vygmaq")
