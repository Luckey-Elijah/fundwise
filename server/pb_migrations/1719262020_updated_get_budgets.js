...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("8p4lhf63")

  // remove
  collection.schema.removeField("fxlavatj")

  // remove
  collection.schema.removeField("qdedlyfw")

  // remove
  collection.schema.removeField("xcviswbw")
