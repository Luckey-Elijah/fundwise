...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("czp5dysb")

  // remove
  collection.schema.removeField("uxlwky50")

  // remove
  collection.schema.removeField("d1jnqqtg")

  // remove
  collection.schema.removeField("wvoxw2mn")
