...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("2hnqu9xs")

  // remove
  collection.schema.removeField("t9cvsgmn")

  // remove
  collection.schema.removeField("1ov3nond")

  // remove
  collection.schema.removeField("du2vrwyk")
